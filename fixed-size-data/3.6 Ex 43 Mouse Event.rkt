...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |3.6 Ex 43 Mouse Event|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
; only tested on laptop mouse pad not with a peripheral mouse
