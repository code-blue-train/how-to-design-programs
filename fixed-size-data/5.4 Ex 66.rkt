...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |5.4 Ex 66|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (make-movie title producer year)
  (title producer year))
(make-movie "The Godfather" "Bob Evans" 1971)
;selector
...
(make-person "Merrick" "blonde" "blue" "555-555-5555")
;selector
...
(define (make-CD artist title price)
  artist title price)
(make-CD "Stevie Ray Vaughan" "Texas Flood" 12.99)
; selector
